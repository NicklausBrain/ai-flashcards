...
$Prompt = @"
# ROLE
You are an expert Senior Software Engineer with strong expertise in TypeScript, Node.js, Git workflows, and automated bug fixing.
...
2. Apply a code fix to the file at `"filePath"` that resolves the bug described.
